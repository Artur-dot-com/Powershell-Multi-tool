 ...
 $Form.Size = New-Object System.Drawing.Size(600, 800)  # Kohanda vormi esialgset suurust
 $Form.FormBorderStyle = [System.Windows.Forms.FormBorderStyle]::FixedSingle  # Keela suuruse muutmine
 $Form.MaximizeBox = $false  # Keela maksimeerimisnupp
 $Form.MinimizeBox = $false  # Keela minimeerimisnupp
 $Form.StartPosition = [System.Windows.Forms.FormStartPosition]::CenterScreen  # Keskendu ekraanile
 $Form.BackColor = [System.Drawing.Color]::  # Määra taustavärv halliks
 ...
 # Nuppude parameetrid
 $ButtonWidth = 250  # Kohanda nuppude laiust
 $ButtonHeight = 50  # Kohanda nuppude kõrgust

 # "Tools" sektsiooni jaoks GroupBox
 $ToolsGroupBox = New-Object System.Windows.Forms.GroupBox
 $ToolsGroupBox.Text = "Tööriistad"
 $ToolsGroupBox.Location = New-Object System.Drawing.Point(20, 20)
 $ToolsGroupBox.Size = New-Object System.Drawing.Size(550, 200)
 $ToolsGroupBox.Font = $Font
    ...
    # Loo nupp Windows 10/11 debloater jaoks
    ...
    $DebloaterButton.Location = New-Object System.Drawing.Point(150, 50)
    $DebloaterButton.Font = $Font

    # Lisa nupud GroupBox-i
